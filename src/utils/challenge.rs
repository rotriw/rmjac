...
pub fn gen_verify_code(captcha: &str, time: &NaiveDateTime, code: &str, dark_mode: bool) -> String {
...
pub fn verify_code(
    ...
    let expected_code = encode_password(&format!("{}@{}@{}@{}", captcha, time, code, dark_mode));
