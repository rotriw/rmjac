import { ContactIcon, CheckCircle2 } from "lucide-react"
        ...
        <div className="container mx-auto py-6 px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                            ...
                            <div className="mt-6 space-y-4">
                                ...
                                <div className="space-y-3 pt-4 border-t border-gray-100">
                                    <div className="flex items-center text-sm text-gray-600">
                                        ...
                                        <span className="text-gray-900 font-bold">{data.pass.length}</span>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                ...
                <div className="md:col-span-9 space-y-6">
                    <StandardCard title="README.md">
                        <TypstRenderer content={data.user.description || ""} />
                    </StandardCard>
                    <StandardCard title="通过" className="w-fit">
                        {data.pass.length === 0 ? (
                            ...
                            data.pass.map((perm) => (
                                <Badge key={perm} className="m-1" variant="outline">
                                    {perm}
                                </Badge>
                            ))
                        )}
