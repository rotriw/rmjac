...
export class CodeforcesVerifyApiKeyService extends EdgeService {
    ...
    protected defineExportDescribe(): StatusDescribe[] {
        return [
            ...
            statusDescribe('platform', 'String'),
            statusDescribe('method', 'String'),
            /* statusDescribe('username', 'String'),
            statusDescribe('user_id', 'String'),
            statusDescribe('password', 'String'),
            , */
        ];
    }

    protected async doExecute(input: Status): Promise<Status> {
        //return VjudgeStatus.error("API Key verification failed");
        ...
        return VjudgeStatus.from(input).withBool('verified', verified).withString('account_id', handleValue);
    }
}
...
export class CodeforcesVerifyTokenService extends EdgeService {
    ...
    protected defineExportDescribe(): StatusDescribe[] {
        return [statusDescribe('verified', 'Bool'), statusDescribe('account_id', 'String')];
    }
...
export class CodeforcesVerifyPasswordService extends EdgeService {
    ...
    protected defineExportDescribe(): StatusDescribe[] {
        return [statusDescribe('verified', 'Bool'), statusDescribe('account_id', 'String'), statusDescribe('session_token', 'String')];
    }
    ...
    protected async doExecute(input: Status): Promise<Status> {
        ...
        const result = VjudgeStatus.from(input).withBool('verified', verified).withString('account_id', handleValue);
...
export function getCodeforcesVerifyServices(): EdgeService[] {
    return [new CodeforcesVerifyApiKeyService(), new CodeforcesVerifyTokenService(), new CodeforcesVerifyPasswordService()];
}
