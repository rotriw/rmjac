...
var MainPageHandler = /** @class */ (function (_super) {
    __extends(MainPageHandler, _super);
    function MainPageHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MainPageHandler.prototype.get = function () {
    ...
    ], MainPageHandler.prototype, "get");
    return MainPageHandler;
}(handle_1.Handler));
function apply() {
    (0, handle_1.Route)('HomePage', '/', MainPageHandler);
}
exports.apply = apply;
